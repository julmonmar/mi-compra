...
const PRODUCTOS_INIT = [
  {id:"p1",  nombre:"Lentejas",        unidad:"kg",   categoria:"Legumbres y conservas", favorito:false},
  {id:"p2",  nombre:"Chorizo",         unidad:"kg",   categoria:"Carnes y embutidos",    favorito:false},
  ...
  {id:"p5",  nombre:"Arroz",           unidad:"kg",   categoria:"Legumbres y conservas", favorito:false},
  {id:"p6",  nombre:"Atún lata",       unidad:"ud",   categoria:"Legumbres y conservas", favorito:false},
  {id:"p7",  nombre:"Merluza",         unidad:"kg",   categoria:"Pescados y mariscos",   favorito:false},
  {id:"p8",  nombre:"Pasta",           unidad:"kg",   categoria:"Legumbres y conservas", favorito:false},
  {id:"p9",  nombre:"Carne picada",    unidad:"kg",   categoria:"Carnes y embutidos",    favorito:false},
  {id:"p10", nombre:"Tomate frito",    unidad:"ud",   categoria:"Legumbres y conservas", favorito:false},
  {id:"p11", nombre:"Huevos",          unidad:"ud",   categoria:"Lácteos y huevos",      favorito:false},
  {id:"p12", nombre:"Champiñones",     unidad:"kg",   categoria:"Frutas y verduras",     favorito:false},
  ...
  {id:"p15", nombre:"Tomate",          unidad:"kg",   categoria:"Frutas y verduras",     favorito:false},
  {id:"p16", nombre:"Aceite oliva",    unidad:"L",    categoria:"Aceites, salsas y condimentos", favorito:true},
  {id:"p17", nombre:"Gambas",          unidad:"kg",   categoria:"Pescados y mariscos",   favorito:false},
  {id:"p18", nombre:"Pechuga",         unidad:"kg",   categoria:"Carnes y embutidos",    favorito:false},
  {id:"p19", nombre:"Calabaza",        unidad:"kg",   categoria:"Frutas y verduras",     favorito:false},
  {id:"p20", nombre:"Bacalao",         unidad:"kg",   categoria:"Pescados y mariscos",   favorito:false},
  ...
  {id:"p24", nombre:"Salmón",          unidad:"kg",   categoria:"Pescados y mariscos",   favorito:false},
  {id:"p25", nombre:"Mozzarella",      unidad:"kg",   categoria:"Lácteos y huevos",      favorito:false},
  {id:"p26", nombre:"Bechamel",        unidad:"ud",   categoria:"Legumbres y conservas", favorito:false},
  {id:"p27", nombre:"Queso rallado",   unidad:"kg",   categoria:"Lácteos y huevos",      favorito:false},
  {id:"p28", nombre:"Puerros",         unidad:"ud",   categoria:"Frutas y verduras",     favorito:false},
  {id:"p29", nombre:"Fabes",           unidad:"kg",   categoria:"Legumbres y conservas", favorito:false},
  {id:"p30", nombre:"Morcilla",        unidad:"kg",   categoria:"Carnes y embutidos",    favorito:false},
  {id:"p31", nombre:"Fruta variada",   unidad:"kg",   categoria:"Frutas y verduras",     favorito:true},
  {id:"p32", nombre:"Pan",             unidad:"ud",   categoria:"Panadería, bollería y snacks", favorito:true},
  {id:"p33", nombre:"Papel higiénico", unidad:"ud",   categoria:"Limpieza",              favorito:true},
];

const PLATOS_INIT = [
  {id:"pl1",  nombre:"Lentejas con chorizo",   tipo:"almuerzo", prods:[{pid:"p1",c:0.5},{pid:"p2",c:0.2},{pid:"p13",c:1}]},
  {id:"pl2",  nombre:"Pollo al horno",         tipo:"almuerzo", prods:[{pid:"p3",c:1.2},{pid:"p4",c:1},{pid:"p16",c:0.05}]},
  {id:"pl3",  nombre:"Arroz con atún",         tipo:"almuerzo", prods:[{pid:"p5",c:0.3},{pid:"p6",c:2},{pid:"p15",c:0.2}]},
  {id:"pl4",  nombre:"Merluza al vapor",       tipo:"almuerzo", prods:[{pid:"p7",c:0.6},{pid:"p4",c:0.5}]},
  {id:"pl5",  nombre:"Pasta boloñesa",         tipo:"almuerzo", prods:[{pid:"p8",c:0.5},{pid:"p9",c:0.4},{pid:"p10",c:1}]},
  {id:"pl6",  nombre:"Paella de pollo",        tipo:"almuerzo", prods:[{pid:"p3",c:1},{pid:"p5",c:0.4},{pid:"p23",c:2}]},
  {id:"pl7",  nombre:"Cocido madrileño",       tipo:"almuerzo", prods:[{pid:"p9",c:0.3},{pid:"p1",c:0.2},{pid:"p29",c:0.2},{pid:"p30",c:0.15}]},
  {id:"pl8",  nombre:"Salmón al horno",        tipo:"almuerzo", prods:[{pid:"p24",c:0.6},{pid:"p4",c:0.4}]},
  {id:"pl9",  nombre:"Macarrones gratinados",  tipo:"almuerzo", prods:[{pid:"p8",c:0.5},{pid:"p26",c:1},{pid:"p27",c:0.2}]},
  {id:"pl10", nombre:"Tortilla de patatas",    tipo:"cena",     prods:[{pid:"p11",c:6},{pid:"p4",c:0.5},{pid:"p16",c:0.05}]},
  {id:"pl11", nombre:"Crema de verduras",      tipo:"cena",     prods:[{pid:"p19",c:0.5},{pid:"p28",c:2},{pid:"p22",c:0.2}]},
  {id:"pl12", nombre:"Huevos con champiñones", tipo:"cena",     prods:[{pid:"p11",c:4},{pid:"p12",c:0.3}]},
  {id:"pl13", nombre:"Ensalada mixta",         tipo:"cena",     prods:[{pid:"p14",c:1},{pid:"p15",c:0.2},{pid:"p16",c:0.03}]},
  {id:"pl14", nombre:"Revuelto de gambas",     tipo:"cena",     prods:[{pid:"p17",c:0.3},{pid:"p11",c:4}]},
  {id:"pl15", nombre:"Crema de calabaza",      tipo:"cena",     prods:[{pid:"p19",c:0.8},{pid:"p22",c:0.2}]},
  {id:"pl16", nombre:"Ensalada caprese",       tipo:"cena",     prods:[{pid:"p15",c:0.3},{pid:"p25",c:0.25}]},
];
...
export default function App() {
  ...
  function guardarFirebase(estado) {
    ...
    timer.current = setTimeout(() => {
      ...
      setDoc(doc(db, "compra", DOC_ID), estado)
        .finally(() => setTimeout(() => { guardando.current = false; }, 500));
    }, 800);
  }
  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(ref, snap => {
      ...
      if (snap.exists()) {
        ...
        setPantalla(pa === "super" && (d.listaSuper||[]).length > 0 ? "super" : "lista");
      } else {
        const inicial = {
          pantalla:"lista", productos:PRODUCTOS_INIT, platos:PLATOS_INIT,
          semanas:SEMANAS_INIT, idxSemana:0, quitados:[], checks:{}, listaSuper:[],
        };
        setDoc(ref, inicial);
      }
      setCargado(true);
  ...
  useEffect(() => {
    if (!cargado) return;
    guardarFirebase({ pantalla, productos, platos, semanas, idxSemana, quitados, checks, listaSuper });
  }, [pantalla, productos, platos, semanas, idxSemana, quitados, checks, listaSuper, cargado]);
  ...
  function rotarSemana() {
    ...
    // Guardar directamente en Firebase sin esperar debounce
    const nuevoEstado = {
      pantalla:"lista", productos, platos, semanas,
      idxSemana: nuevaIdx, quitados:[], checks: nuevosChecks,
      listaSuper: nuevaListaSuper,
    };
    guardando.current = true;
    setDoc(doc(db, "compra", DOC_ID), nuevoEstado)
      .finally(() => setTimeout(() => { guardando.current = false; }, 500));
  ...
  function toggleCheck(pid) {
    ...
    const prod       = productos.find(p=>p.id===pid);
    if (!prod) return;
    const esManual   = !mapaMenu[pid] && !prod.favorito;
    ...
    if (listaSuper.length > 0) {
      if (nuevoValor) {
        if (!listaSuper.find(p=>p.id===pid)) {
          setListaSuper(l=>[...l, {
            id:prod.id, nombre:prod.nombre,
            cantidad: mapaMenu[pid] ? mapaMenu[pid].cantidad : 1,
            unidad:prod.unidad, categoria:prod.categoria,
  ...
  function irAlSuper() {
    if (listaSuper.length > 0) { setPantalla("super"); return; }
    const mapaMenu = calcMapaMenu(semana, platos, productos, quitados);
    const lista = [];
    productos.forEach(prod => {
  ...
  return (
    <Lista
      ...
      quitados={quitados} quitarPlato={quitarPlato}
...
function Lista({ semana, platos, productos, quitados, quitarPlato,
  checks, toggleCheck, irAlSuper, abrirAjustes }) {
      ...
      <div style={S.header}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:10}}>
          <div>
            ...
            <div style={{display:"flex",alignItems:"center",gap:10}}>
              <div style={{...S.titulo,fontSize:28,letterSpacing:"-1px"}}>La Compra</div>
              <div style={{width:10,height:10,borderRadius:"50%",background:color,
                boxShadow:`0 0 8px ${color}88`,marginBottom:2,flexShrink:0}}/>
            </div>
          </div>
        ...
        <div style={{marginTop:12}}>
          <Tabs tab={tab} setTab={setTab} color={color}
            tabs={[["lista","📝 Lista"],["menu","🍽 Menú"]]}/>
        </div>
      </div>

      <div style={S.scroll}>
        {tab==="menu" && (
          <TabMenu semana={semana} platos={platos} productos={productos}
            quitados={quitados} quitarPlato={quitarPlato} color={color}/>
        )}
        {tab==="lista" && (
...
function TabMenu({ semana, platos, productos, quitados, quitarPlato, color }) {
  return (
    <div style={{padding:"18px 20px 0"}}>
      <div style={{color:"#555",fontSize:12,marginBottom:14,lineHeight:1.6}}>
        Toca un plato para quitarlo esta semana.
      </div>
            ...
            return (
              <div key={platId} onClick={()=>quitarPlato(platId,tipo)}
                ...
                <span style={{flex:1,fontSize:15,color:fuera?"#444":"#F0EAD6",
                  textDecoration:fuera?"line-through":"none"}}>{plato.nombre}</span>
...
function TabLista({ productos, idsActivos, mapaMenu, checks, toggleCheck, color, totalComprar }) {
  return (
    <div style={{padding:"18px 20px 0"}}>
      ...
      {CATEGORIAS.map(cat => {
        const prodsEnCat = productos.filter(p=>p.categoria===cat)
          ...
          <div key={cat} style={{marginBottom:22}}>
            <div style={S.catHeaderEl}>
              ...
              <span style={{color:"#444",fontSize:11}}>
                {prodsEnCat.filter(p=>{const ch=checks[p.id];return ch!==undefined?ch:idsActivos.has(p.id);}).length}/{prodsEnCat.length}
              </span>
            </div>
            {activos.map(p => {
              ...
              return (
                <div key={p.id} onClick={()=>toggleCheck(p.id)}
                  ...
                  <div style={{...S.check,background:checked?color:"transparent",borderColor:checked?color:"#2a2720"}}>
                  ...
                  <span style={{flex:1,fontSize:15,color:checked?"#F0EAD6":"#555",
                    textDecoration:checked?"none":"line-through"}}>{p.nombre}</span>
            ...
            {restantes.map(p => {
              ...
              return (
                <div key={p.id} onClick={()=>toggleCheck(p.id)}
                  ...
                  <div style={{...S.check,background:checked?color:"transparent",borderColor:checked?color:"#252220"}}>
                    {checked&&<span style={{color:"#0F0E0C",fontSize:10,fontWeight:"bold",lineHeight:1}}>✓</span>}
                  </div>
                  <span style={{flex:1,fontSize:15,color:checked?"#C8B89A":"#444"}}>{p.nombre}</span>
                </div>
              );
            })}
          </div>
    ...
    <div style={S.app}>
      ...
      <div style={S.header}>
        <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:14}}>
          ...
          <button onClick={siguienteSemana}
            style={{background:"#4caf87",border:"none",color:"#fff",
              padding:"8px 18px",borderRadius:10,cursor:"pointer",
              fontSize:14,fontWeight:"bold",letterSpacing:"0.02em",
              display:"flex",alignItems:"center",gap:6,
              boxShadow:"0 3px 12px #4caf8766"}}>
            ✓ Finalizar
          </button>
        </div>
        <div style={{display:"flex",justifyContent:"space-between",marginBottom:6}}>
          <span style={{fontSize:12,color:"#555"}}>{comprados} de {total} productos</span>
          <span style={{fontSize:12,color:listo?"#7EB8A4":"#555"}}>{listo?"🎉 ¡Listo!":pct+"%"}</span>
        </div>
      ...
      <div style={{...S.scroll,padding:"0 20px"}}>
        ...
        {Object.entries(porCat).map(([cat,items])=>(
          <div key={cat} style={{marginBottom:4}}>
            <div style={{display:"flex",alignItems:"center",gap:10,
              marginBottom:6,paddingBottom:8,marginTop:24,borderBottom:"2px solid #1E1C18"}}>
              <span style={{fontSize:18}}>{ICONOS[cat]||"📦"}</span>
              <span style={{flex:1,fontSize:13,color:"#C8A96E",fontWeight:"900",
                letterSpacing:"0.08em",textTransform:"uppercase"}}>{cat}</span>
            ...
            {items.map(p=>(
              <div key={p.id} onClick={()=>marcarComprado(p.id)}
                ...
                <div style={{...S.check,background:p.comprado?"#7EB8A4":"transparent",
                  borderColor:p.comprado?"#7EB8A4":"#333"}}>
                  {p.comprado&&<span style={{color:"#0F0E0C",fontSize:10,fontWeight:"bold",lineHeight:1}}>✓</span>}
                </div>
                <span style={{flex:1,fontSize:15,textDecoration:p.comprado?"line-through":"none",
                  color:p.comprado?"#444":"#F0EAD6"}}>{p.nombre}</span>
...
function Ajustes({productos,setProductos,platos,setPlatos,semanas,setSemanas,volver}) {
  ...
  const secs = [["productos","🥕 Productos"],["platos","👨‍🍳 Recetas"],["semanas","📅 Semanas"]];
  return (
    <div style={S.app}>
      <div style={S.glow}/>
      <div style={S.header}>
        ...
        <div style={{display:"flex",gap:2,marginTop:4}}>
          {secs.map(([k,l])=>(
            <button key={k} onClick={()=>setSec(k)}
              style={{flex:1,padding:"13px 4px",border:"none",background:"transparent",
                color:sec===k?"#C8A96E":"#444",cursor:"pointer",fontSize:15,
                fontWeight:sec===k?"700":"400",letterSpacing:"0.01em",
                borderBottom:`3px solid ${sec===k?"#C8A96E":"transparent"}`,transition:"all .2s"}}>
              {l}
            </button>
          ))}
        </div>
...
function SecSemanas({semanas,setSemanas,platos,productos}) {
  ...
  return(
    <div>
      <Hint>Configura los platos de cada semana.</Hint>
      {semanas.map(sem=>(
...
Categorías disponibles: ${CATS.join(", ")}.`;
    try {
      let content;
      if (ia.imagen) {
        content = [{type:"image",source:{type:"base64",media_type:ia.imagenTipo,data:ia.imagen}},{type:"text",text:PROMPT}];
      } else {
        content = `${PROMPT}\nReceta: ${ia.texto}`;
      }
  ...
  function handleImagen(e) {
    ...
    reader.onload=ev=>{const b64=ev.target.result.split(",")[1];setIa(s=>({...s,imagen:b64,imagenTipo:file.type,texto:""}));};
  ...
  function confirmarReceta() {
    ...
    const nuevosProds=[]; const prodsPlato=[];
    r.ingredientes.forEach(ing=>{
      const existe=productos.find(p=>p.nombre.toLowerCase().trim()===ing.nombre.toLowerCase().trim());
      if(existe){ prodsPlato.push({pid:existe.id,c:ing.cantidad||1}); }
      else {
        const id=`p${Date.now()}${Math.random().toString(36).slice(2,6)}`;
        const unidad=["ud","kg","L"].includes(ing.unidad)?ing.unidad:"ud";
        const categoria=CATEGORIAS.includes(ing.categoria)?ing.categoria:"Otros";
        nuevosProds.push({id,nombre:ing.nombre,unidad,categoria,favorito:false});
        prodsPlato.push({pid:id,c:ing.cantidad||1});
      }
    });
    if(nuevosProds.length>0) setProductos(p=>[...p,...nuevosProds]);
    setPlatos(p=>[...p,{id:`pl${Date.now()}`,nombre:r.nombre,tipo:r.tipo,prods:prodsPlato}]);
    setIa(null);
  }
  ...
  return(
    <div>
      ...
      {[["almuerzo","☀️ Almuerzos"],["cena","🌙 Cenas"]].map(([tipo,label])=>(
              ...
              <div style={{display:"flex",alignItems:"center",gap:8}}>
                <div style={{flex:1,cursor:"pointer",color:"#F0EAD6",fontSize:15}}
                  ...
                  <span style={{color:"#555",fontSize:11,marginLeft:8}}>
                    {pl.prods.filter(pr=>productos.find(p=>p.id===pr.pid)).length} prod.
                  </span>
                </div>
      ...
      {ia && !ia.resultado && (
        <div style={{...S.card,marginBottom:10,borderColor:"#C8A96E44"}}>
          <div style={{color:"#C8A96E",fontSize:13,marginBottom:10,fontWeight:"bold"}}>✨ Añadir receta con IA</div>
          ...
          <div style={{display:"flex",gap:4,marginBottom:10}}>
            {[["texto","📝 Texto"],["imagen","📷 Imagen"]].map(([m,l])=>(
              <button key={m} onClick={()=>setIa(s=>({...s,modo:m,imagen:null}))}
                style={{flex:1,padding:"7px",border:"none",borderRadius:6,cursor:"pointer",fontSize:12,
                  background:(!ia.modo&&m==="texto")||ia.modo===m?"#C8A96E22":"transparent",
                  color:(!ia.modo&&m==="texto")||ia.modo===m?"#C8A96E":"#555",
                  borderBottom:`2px solid ${(!ia.modo&&m==="texto")||ia.modo===m?"#C8A96E":"transparent"}`}}>
                {l}
              </button>
            ))}
          </div>
          {(!ia.modo||ia.modo==="texto") && (
            <textarea placeholder="Pega aquí la receta..." value={ia.texto}
              onChange={e=>setIa(s=>({...s,texto:e.target.value}))} rows={5}
              style={{...S.input,width:"100%",boxSizing:"border-box",marginBottom:10,resize:"vertical",lineHeight:1.5}}/>
          )}
          {ia.modo==="imagen" && (
            <div style={{marginBottom:10}}>
              <label style={{display:"block",cursor:"pointer"}}>
                <div style={{...S.input,width:"100%",boxSizing:"border-box",textAlign:"center",
                  padding:"20px 12px",borderStyle:"dashed",color:ia.imagen?"#7EB8A4":"#555",cursor:"pointer"}}>
              ...
              {ia.imagen && (
                <button onClick={()=>setIa(s=>({...s,imagen:null}))}
                  style={{...S.btnGhost,width:"100%",marginTop:6,fontSize:12}}>✕ Quitar imagen</button>
              )}
            </div>
          )}
      ...
      {ia?.resultado && (
        <div style={{...S.card,marginBottom:10,borderColor:"#7EB8A444"}}>
          <div style={{color:"#7EB8A4",fontSize:13,marginBottom:12,fontWeight:"bold"}}>✓ Revisión antes de guardar</div>
          <div style={{color:"#F0EAD6",fontSize:15,marginBottom:4}}>{ia.resultado.nombre}</div>
          <div style={{color:"#888",fontSize:11,marginBottom:12}}>{ia.resultado.tipo} · {ia.resultado.ingredientes?.length} ingredientes</div>
          {ia.resultado.ingredientes?.map((ing,i)=>{
            const existe=productos.find(p=>p.nombre.toLowerCase()===ing.nombre.toLowerCase());
            return(
              <div key={i} style={{background:"#1C1A17",borderRadius:8,padding:"8px 10px",marginBottom:4}}>
                <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:existe?0:6}}>
                  <span style={{fontSize:11,color:existe?"#7EB8A4":"#C8A96E",minWidth:14}}>{existe?"✓":"＋"}</span>
                ...
                {!existe&&(
                  <select value={ing.categoria||"Otros"}
                    onChange={e=>{const n=[...ia.resultado.ingredientes];n[i]={...n[i],categoria:e.target.value};setIa(s=>({...s,resultado:{...s.resultado,ingredientes:n}}));}}
          ...
          <div style={{fontSize:11,color:"#555",margin:"10px 0"}}>✓ verde = ya en catálogo &nbsp;·&nbsp; ＋ dorado = nuevo</div>
          <div style={{display:"flex",gap:8}}>
            <button onClick={confirmarReceta} style={{...S.btnPrimary,flex:2,background:"#7EB8A4",color:"#0F0E0C"}}>✓ Guardar</button>
            <button onClick={()=>setIa(null)} style={{...S.btnGhost,flex:1}}>Cancelar</button>
          </div>
        </div>
      )}
      ...
      {nuevo?(
        ...
        <div style={{display:"flex",gap:8,marginTop:4}}>
          <button onClick={()=>setIa({tipo:"almuerzo",texto:"",analizando:false,resultado:null})}
            style={{...S.btnPrimary,flex:1,background:"#C8A96E22",color:"#C8A96E",border:"1px solid #C8A96E44"}}>
            ✨ Con IA
          </button>
          <button onClick={()=>setNuevo({id:`pl${Date.now()}`,nombre:"",tipo:"almuerzo",prods:[]})}
            style={{...S.btnGhost,flex:1,borderStyle:"dashed"}}>+ Manual</button>
        </div>
      )}
    </div>
  );
...
function SecProductos({productos,setProductos,platos}) {
  ...
  function toggleFav(id){
    setProductos(p=>p.map(x=>x.id===id
      ?{...x,favorito:!x.favorito,cantidadFav:x.favorito?undefined:(x.cantidadFav||1)}:x));
  }
  ...
  function pedirConfirmacion(prod){
    const afectados=(platos||[]).filter(pl=>(pl.prods||[]).some(pr=>(pr.pid||pr.id)===prod.id));
    if(afectados.length===0) setProductos(p=>p.filter(x=>x.id!==prod.id));
    else setConfirm({id:prod.id,nombre:prod.nombre,platosAfectados:afectados});
  }
  ...
  function guardarEdicion(){
    ...
    setProductos(p=>p.map(x=>x.id===editando.id
      ?{...x,nombre:editando.nombre.trim(),unidad:editando.unidad,categoria:editando.categoria}:x));
    setEdit(null);
  }
  ...
  return(
    <div>
      <Hint>⭐ Toca la estrella para que un producto aparezca automáticamente todas las semanas e introduce su cantidad.</Hint>
      ...
      {editando && (
        <div style={{...S.card,marginBottom:12,borderColor:"#C8A96E44"}}>
          ...
          <input autoFocus placeholder="Nombre" value={editando.nombre}
            ...
            style={{...S.input,width:"100%",boxSizing:"border-box",marginBottom:8}}/>
          <select value={editando.unidad} onChange={e=>setEdit(ed=>({...ed,unidad:e.target.value}))}
            style={{...S.input,width:"100%",boxSizing:"border-box",marginBottom:8}}>
            <option value="ud">ud — unidades</option>
            <option value="kg">kg — kilos</option>
            <option value="L">L — litros</option>
          </select>
          <select value={editando.categoria} onChange={e=>setEdit(ed=>({...ed,categoria:e.target.value}))}
            style={{...S.input,width:"100%",boxSizing:"border-box",marginBottom:10}}>
            {CATEGORIAS.map(c=><option key={c}>{c}</option>)}
          </select>
          <div style={{display:"flex",gap:8}}>
            <button onClick={guardarEdicion} style={{...S.btnPrimary,flex:1,background:"#C8A96E",color:"#0F0E0C"}}>Guardar</button>
      ...
      {confirmando && (
        <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.75)",zIndex:100,
          ...
          <div style={{...S.card,maxWidth:340,width:"100%",borderColor:"#C47E7E55"}}>
            <div style={{fontSize:16,color:"#F0EAD6",marginBottom:8}}>⚠️ Eliminar producto</div>
            ...
            <div style={{fontSize:12,color:"#666",marginBottom:16}}>Si lo eliminas, se borrará de todos ellos.</div>
            <div style={{display:"flex",gap:8}}>
              <button onClick={()=>setConfirm(null)} style={{...S.btnGhost,flex:1}}>Cancelar</button>
              <button onClick={confirmarEliminar} style={{...S.btnPrimary,flex:1,background:"#C47E7E",color:"#fff"}}>
                Eliminar igualmente
              </button>
            </div>
          </div>
          ...
          {items.map(p=>(
            <div key={p.id} style={{...S.itemRow,cursor:"default",
              ...
              <button onClick={()=>toggleFav(p.id)}
                style={{...S.btnIcon,fontSize:16,padding:"2px 5px",color:p.favorito?"#C8A96E":"#444"}}>
                {p.favorito?"⭐":"☆"}
              </button>
      ...
      {nuevo?(
        <div style={S.card}>
          ...
          <input placeholder="Nombre" value={nuevo.nombre||""}
            onChange={e=>setNuevo(n=>({...n,nombre:e.target.value}))}
            style={{...S.input,width:"100%",boxSizing:"border-box",marginBottom:8}}/>
          <select value={nuevo.unidad||"ud"} onChange={e=>setNuevo(n=>({...n,unidad:e.target.value}))}
            style={{...S.input,width:"100%",boxSizing:"border-box",marginBottom:8}}>
            <option value="ud">ud — unidades</option>
            <option value="kg">kg — kilos</option>
            <option value="L">L — litros</option>
        ...
        <button onClick={()=>setNuevo({nombre:"",unidad:"ud",categoria:"Otros"})}
          style={{...S.btnGhost,width:"100%",borderStyle:"dashed"}}>+ Nuevo producto</button>
      )}
    </div>
  );
}
      ...
      {tabs.map(([k,l])=>(
        <button key={k} onClick={()=>setTab(k)}
          style={{flex:1,padding:small?"7px 4px":"13px 4px",
            ...
            fontSize:small?12:15,fontWeight:tab===k?"700":"400",
...
const S = {
  ...
  header:    {background:"rgba(13,12,10,0.97)",borderBottom:"1px solid #1E1C18",
              padding:"20px 20px 0",position:"sticky",top:0,zIndex:10,backdropFilter:"blur(12px)"},
  titulo:    {fontSize:24,fontWeight:"bold",color:"#F0EAD6",letterSpacing:"-0.8px",lineHeight:1.1},
  ...
  catHeaderEl:{display:"flex",alignItems:"center",gap:10,fontSize:13,color:"#C8A96E",
  ...
  btnSuper:  {width:"100%",border:"none",color:"#0D0C0A",padding:"17px",
              ...
              letterSpacing:"-0.2px",transition:"transform .1s, box-shadow .2s"},
  ...
  btnPrimary:{background:"#C8A96E",border:"none",color:"#0D0C0A",padding:"11px 18px",
              borderRadius:10,cursor:"pointer",fontSize:13,fontWeight:"bold",letterSpacing:"0.01em"},
  ...
  platoCard: {display:"flex",alignItems:"center",gap:12,padding:"12px 10px",
              borderRadius:10,marginBottom:4,border:"1px solid",cursor:"pointer",transition:"all .2s"},
  ...
  input:     {background:"#0F0E0C",border:"1px solid #2a2720",color:"#F0EAD6",
              padding:"10px 13px",borderRadius:10,fontSize:13,outline:"none"},
};
